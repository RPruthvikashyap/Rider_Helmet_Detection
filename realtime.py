    ...
    if len(indexes) > 0:
        for i in indexes.flatten():
            ...
            if label == 'Not Wearing Helmet':
                ...
                color = (0, 255, 0) # Change color to red for not wearing helmet
                
                # extract face region
                face_img = img[y:y+h, x:x+w]
                
                # save image to folder
                count = len(os.listdir("Helmet"))
                if face_img.size > 0:
                    cv2.imwrite("Helmet/Helmet_{}.jpg".format(count), face_img)   
...
>>>>>>> da40769d658f649f34287e536164b0bbcde5a826
